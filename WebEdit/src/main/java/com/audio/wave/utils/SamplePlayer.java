...
public class SamplePlayer {
    ...
    public SamplePlayer(SoundFile mSoundFile, Handler mHandler) {
        this(mSoundFile.getSamples(), mSoundFile.getSampleRate(),
                mSoundFile.getChannels(), mSoundFile.getNumSamples());
        ...
        mAudioTrack.setPlaybackPositionUpdateListener(
                new AudioTrack.OnPlaybackPositionUpdateListener() {
                    ...
                    public void onPeriodicNotification(AudioTrack track) {
                        Log.d(this.getClass().getName(), "onPeriodicNotification");
                    }

                    @Override
                    public void onMarkerReached(AudioTrack track) {
                        Log.d(this.getClass().getName(), "onMarkerReached");
                        stop();
                        if (mListener != null) {
    ...
    public void play() {
        ...
        mPlayThread = new Thread() {
            public void run() {
                ...
                if (mHandler != null && mSamples.position() >= limit) {
