...
import enlightenment.com.tool.Image.ImageUtils;
...
public class ZoomImageView extends AppCompatImageView {
    ...
    private int mHorizontalPadding = 20;        // 水平方向与View的边距
    private int mVerticalPadding = 0;           //垂直方向与View的边距
    private int mClipViewWidth = 0;               //切割窗口大小
    /**
     * 初始化状态常量
     */
    ...
    protected void onDraw(Canvas canvas) {
        if (sourceBitmap == null && getDrawable() != null) {
            sourceBitmap = ImageUtils.drawableToBitmap(getDrawable());
        }
